...
const App = () => (
  <div>
    <AppBar color={'default'} position="static">
        <Toolbar>
          <IconButton style={{marginRight: '2px'}} edge="start" color="inherit"><Dehaze /></IconButton>
      ...
      <div style={{display: 'grid','gridTemplateRows': '15% 60%',}}>
        <div style={{width: '20%', height: '100%', backgroundColor: '#ffffff', marginTop: '10px', display: 'grid',}}>
          ...
          <div style={{marginLeft: '20px', height: '25px', padding: '10px', textAlign: 'left', borderRadius: "0px 20px 20px 0px",}}>
              <Notifications />
              <label style={{marginLeft: '40px',}}>Reminders</label></div><br />
          <Divider />
          <h5>Labels</h5>
          <div style={{marginLeft: '20px', height: '25px', padding: '10px', textAlign: 'left', borderRadius: "0px 20px 20px 0px",}}>
